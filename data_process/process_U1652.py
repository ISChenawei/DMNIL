...
- Original dataset path: DMNIL/dataset/U1652/train/satellite_origin  
- Target dataset path:   DMNIL/dataset/U1652/train/satellite  
"""

# data path
original_dataset_root = "DMNIL/dataset/U1652/train/satellite_origin"  # original dataset path
target_dataset_root = "DMNIL/dataset/U1652/train/satellite"      # target dataset path
    ...
    if os.path.isdir(folder_path):
        ...
        if image_files:
            for i in range(1, 50):
                ...
                new_image_name = f"image-{i:02d}.jpg"  # naming: image-01.jpg to image-50.jpg
