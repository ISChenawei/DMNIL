...
class SUES_dor(BaseImageDataset):
    """
    Market1501
    Reference:
    ...
    def __init__(self, root, verbose=True, **kwargs):
        super(SUES_dor, self).__init__()
        root='sample4geo/dataset'
        # print('regdb_rgb',trial)
        self.dataset_dir = osp.join(root, self.dataset_dir)
        self.train_dir = osp.join(self.dataset_dir, 'Training/150/drone')
        self.query_dir = osp.join(self.dataset_dir, 'Testing/150/query_drone')
        self.gallery_dir = osp.join(self.dataset_dir, 'Testing/150/gallery_drone')
